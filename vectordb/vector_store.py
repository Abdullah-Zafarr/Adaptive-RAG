...
# Manages Supabase vector store table, document embeddings, pgvector RPC matches, and fallback search.
class VectorStoreManager:
    ...
    # Generates dense vector embeddings for text chunks and upserts records into Supabase 'documents' table
    ...
    # Embeds query and calculates nearest neighbors via Supabase RPC or client cosine distance
