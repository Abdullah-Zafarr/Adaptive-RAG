# Formats context chunks and user question for zero-hallucination grounded responses
...
1. Grounding & Anti-Hallucination: Answer using the facts present in the provided Context Chunks. You may count, synthesize, or deduce answers from items explicitly listed in the context. If the answer cannot be deduced or inferred from the context, state clearly: "I am sorry, but the provided knowledge base documents do not contain sufficient information to answer this question."
